...
class User(AbstractUser):
    ...
    class Role(models.TextChoices):
        # Generic platform roles
        ADMIN = 'admin', 'Administrator'
        MANAGER = 'manager', 'Manager'
        ANALYST = 'analyst', 'Analyst'
        VIEWER = 'viewer', 'Viewer'
        
        # Legacy investment-specific roles (deprecated)
        BUSINESS_ANALYST = 'business_analyst', 'Business Analyst'  # Use ANALYST instead
        PORTFOLIO_MANAGER = 'portfolio_manager', 'Portfolio Manager'  # Use MANAGER instead
        EXTERNAL_PARTNER = 'external_partner', 'External Partner'  # Use VIEWER with restrictions
        AUDITOR = 'auditor', 'Auditor'  # Use VIEWER with audit permissions
        READ_ONLY = 'read_only', 'Read Only'  # Use VIEWER instead
...
# NOTE: GuestAccess model moved to investment module as it's assessment-specific
